...
const handleToggleSidebarCategory = () => {
    let buttonFilter = $('#toggleFilter');
    buttonFilter.click(function () {
        let categorySidebar = $('#category-sidebar'),
            categoryGrid = $('#category-grid'),
            columnProduct = $('.column-product');
        if (!buttonFilter.hasClass('is-show_sidebar')) {
            buttonFilter.addClass('is-show_sidebar');
            categorySidebar.show();
            if (windowWidth >= 992) {
                categoryGrid.removeClass('col-lg-12').addClass('col-lg-9');
                columnProduct.removeClass('col-lg-3').addClass('col-lg-4');
            }
        } else {
            buttonFilter.removeClass('is-show_sidebar');
            categorySidebar.hide();
            if (windowWidth >= 992) {
                categoryGrid.removeClass('col-lg-9').addClass('col-lg-12');
                columnProduct.removeClass('col-lg-4').addClass('col-lg-3');
            }
        }
    });
